...
@pytest.mark.parametrize('ensemble, params, expected', [
    ('undefined', {}, []),
    ...
    ('parity grand canonical', {'sites': 7, 'parity': 0}, [(7, 0), (7, 2), (7, 4), (7, 6)]),
    ('parity grand canonical', {'terms': {'t': {0: 1., 5: 1.}}}, [(6, 0), (6, 2), (6, 4), (6, 6)]),
    ('parity grand canonical', {'terms': {'t': {0: 1., 5: 1.}}, 'parity': 1},
        [(6, 1), (6, 3), (6, 5)]),

    ('grand canonical', {}, []),
    ('grand canonical', {'sites': 4}, [(4, 0), (4, 1), (4, 2), (4, 3), (4, 4)]),
    ('grand canonical', {'terms':{'t':{(0, 4): 1.}}},
...
@pytest.mark.parametrize('ranks, sectors, expected', [
    ([], [], []),
